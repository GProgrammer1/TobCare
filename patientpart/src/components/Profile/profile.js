...
const ProfilePage = () => {
    ...
    if (currentPage === 'medical-records') {
      return <MedicalRecords onBack={() => setCurrentPage('profile')} />;
    }
    ...
    <div className="profile-container">
      ...
      <div className="content-section">
        ...
        <div className="menu-container">
          ...
          <button className="menu-item" onClick={() => setCurrentPage('medical-records')}>
            <div className="menu-item-left">
          ...
          <button className="menu-item" onClick={() => setCurrentPage('about-us')}>
            <div className="menu-item-left">
